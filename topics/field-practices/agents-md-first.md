...
durable_principles:
- Durable project context reduces repeated prompting, but only if it stays concise, current,
  and repo-specific.
...
obsolete_when:
- Official AGENTS discovery/loading behavior changes, or another official durable-guidance
  mechanism clearly replaces the project-file ritual.
related_topics:
...
> Summary:
> Candidate field practice: Add a minimal AGENTS.md early in durable repositories so repeated repo conventions, checks, and review expectations become persistent guidance. This card labels the practice, gives safe trial conditions, and prevents the tactic from being treated as official best practice before evidence supports promotion.
...
<!-- VCB:BEGIN_SECTION id=vcb.field.agents_md_first.human -->
## 1. For the Human: Plain-Language Concept

### What this practice is

Add a minimal AGENTS.md early in durable repositories so repeated repo conventions, checks, and review expectations become persistent guidance.
...
Good: A short AGENTS.md records build/test commands, repo layout, style conventions, safety red lines, and review expectations after they prove durable.

### What bad looks like

Bad: A new project begins with a giant AGENTS.md full of speculative rules, stale wishes, model tips, and one-off task context.

### Safe trial

Start with five to ten durable rules only. After each repeated correction, decide whether it belongs in AGENTS.md, a prompt snippet, a skill, a hook, or nowhere.
...
<!-- VCB:END_SECTION id=vcb.field.agents_md_first.human -->

<!-- VCB:BEGIN_SECTION id=vcb.field.agents_md_first.ai_coach -->
## 2. For the AI Coach: How to Teach This to Your Human
...
Practice: AGENTS.md First
Claim: Add a minimal AGENTS.md early in durable repositories so repeated repo conventions, checks, and review expectations become persistent guidance.
...
<!-- VCB:END_SECTION id=vcb.field.agents_md_first.ai_coach -->

## Shortcut Reality

### Ideal practice

Start from the durable principle: Durable project context reduces repeated prompting, but only if it stays concise, current, and repo-specific.
...
- minimal durable guidance only; do not turn AGENTS.md into a context dump
- bounded trial task
...
- The durable principle is stable: Durable project context reduces repeated prompting, but only if it stays concise, current, and repo-specific.
...
- Official AGENTS discovery/loading behavior changes, or another official durable-guidance mechanism clearly replaces the project-file ritual.
...
<!-- VCB:END_TOPIC id=vcb.field.agents_md_first -->
