<!-- VCB:BEGIN_TOPIC id=vcb.field.multi_agent_review_consensus version=1.0.1-post-release.issue7 -->
---
...
id: vcb.field.multi_agent_review_consensus
title: Multi-Agent Review Consensus
type: field_practice
status: active
...
durable_principles:
- Independent perspectives can reduce blind spots, but agreement is not proof without artifact-level
  verification.
...
obsolete_when:
- Parallel-agent review becomes natively scored, deduplicated, and tied to verifiable artifacts
  with clear reliability metrics.
related_topics:
...
> Summary:
> Needs-more-evidence field practice: Use multiple agents for independent review or analysis, then compare evidence and disagreement instead of treating consensus as correctness. This card labels the practice, gives safe trial conditions, and prevents the tactic from being treated as official best practice before evidence supports promotion.
...
<!-- VCB:BEGIN_SECTION id=vcb.field.multi_agent_review_consensus.human -->
## 1. For the Human: Plain-Language Concept

### What this practice is

Use multiple agents for independent review or analysis, then compare evidence and disagreement instead of treating consensus as correctness.
...
Good: Each agent reviews the same diff with the same rubric, reports evidence, uncertainty, and risk; the human compares disagreements before acting.

### What bad looks like

Bad: Three agents say the same thing, so the human merges without checking tests, files, sources, or assumptions.

### Safe trial

Run two independent reviews on a low-risk diff and compare actionable findings, duplicates, misses, and review cost.
...
<!-- VCB:END_SECTION id=vcb.field.multi_agent_review_consensus.human -->

<!-- VCB:BEGIN_SECTION id=vcb.field.multi_agent_review_consensus.ai_coach -->
## 2. For the AI Coach: How to Teach This to Your Human
...
Practice: Multi-Agent Review Consensus
Claim: Use multiple agents for independent review or analysis, then compare evidence and disagreement instead of treating consensus as correctness.
...
<!-- VCB:END_SECTION id=vcb.field.multi_agent_review_consensus.ai_coach -->

## Shortcut Reality

### Ideal practice

Start from the durable principle: Independent perspectives can reduce blind spots, but agreement is not proof without artifact-level verification.
...
- consensus is a prioritization signal, not correctness evidence
- bounded trial task
...
- The durable principle is stable: Independent perspectives can reduce blind spots, but agreement is not proof without artifact-level verification.
...
- Parallel-agent review becomes natively scored, deduplicated, and tied to verifiable artifacts with clear reliability metrics.
...
<!-- VCB:END_TOPIC id=vcb.field.multi_agent_review_consensus -->
