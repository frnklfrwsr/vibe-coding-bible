...
| `cursor.pricing` | https://cursor.com/pricing | Cursor Hobby/Individual Pro/Pro+/Ultra/Teams/Enterprise pricing and usage caveats |
...
| `github.copilot.billing_orgs` | https://docs.github.com/en/copilot/concepts/billing/usage-based-billing-for-organizations-and-enterprises | Organization/enterprise seat pricing, AI credit pooling, and allowances |
| `windsurf.pricing` | https://devin.ai/pricing | Windsurf/Devin Desktop plan pricing, team minimum-charge packaging, usage-overage caveats |
...
- Cursor changes JSON-LD offer prices or visible plan packaging;
