<!-- VCB:BEGIN_TOPIC id=vcb.field.lessons_file_loop version=1.0.1-post-release.issue7 -->
---
...
id: vcb.field.lessons_file_loop
title: Lessons File Loop
type: field_practice
status: active
...
durable_principles:
- Repeated mistakes should become persistent instructions only after they prove durable and
  specific.
...
obsolete_when:
- Official memory, AGENTS.md, skills, or project-guidance mechanisms make a separate lessons
  file redundant for the repo.
related_topics:
- tool.codex_agents_md
- tool.codex_skills
- vcb.shortcut.stale_agents_md
- vcb.shortcut.overstuffing_agents_md
- vcb.field.agents_md_first
...
> Summary:
> Candidate field practice: Capture repeated corrections in a lessons file or durable guidance loop, then periodically promote only stable lessons into AGENTS.md, skills, hooks, or prompts. This card labels the practice, gives safe trial conditions, and prevents the tactic from being treated as official best practice before evidence supports promotion.
...
<!-- VCB:BEGIN_SECTION id=vcb.field.lessons_file_loop.human -->
## 1. For the Human: Plain-Language Concept

### What this practice is

Capture repeated corrections in a lessons file or durable guidance loop, then periodically promote only stable lessons into AGENTS.md, skills, hooks, or prompts.
...
Good: The team records “Codex keeps missing X,” tests the correction twice, then promotes it to the smallest durable artifact and removes stale lessons.

### What bad looks like

Bad: Every annoyance becomes permanent AGENTS.md text, making future sessions longer, noisier, and more contradictory.

### Safe trial

Keep a temporary lessons file for one project phase. Review it weekly: promote, keep testing, or delete each lesson.
...
<!-- VCB:END_SECTION id=vcb.field.lessons_file_loop.human -->

<!-- VCB:BEGIN_SECTION id=vcb.field.lessons_file_loop.ai_coach -->
## 2. For the AI Coach: How to Teach This to Your Human
...
Practice: Lessons File Loop
Claim: Capture repeated corrections in a lessons file or durable guidance loop, then periodically promote only stable lessons into AGENTS.md, skills, hooks, or prompts.
...
<!-- VCB:END_SECTION id=vcb.field.lessons_file_loop.ai_coach -->

## Shortcut Reality

### Ideal practice

Start from the durable principle: Repeated mistakes should become persistent instructions only after they prove durable and specific.
...
- temporary lessons are a staging area, not permanent law
- bounded trial task
...
- The durable principle is stable: Repeated mistakes should become persistent instructions only after they prove durable and specific.
...
- Official memory, AGENTS.md, skills, or project-guidance mechanisms make a separate lessons file redundant for the repo.
...
<!-- VCB:END_TOPIC id=vcb.field.lessons_file_loop -->
